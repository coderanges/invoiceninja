...
from cassandra_db import add_invoice, get_invoice, get_user, add_user
import dotenv
...
def invoice():
    ...
    for x, _ in enumerate(item_name):
        ...
        items.append({
            ...
            'item_qty': item_qty[x],
            'item_unitprice': item_unitprice[x],
            'amount': amount
        })
...
def upload_image(image_data):
    ...
    if 'data' in response.json():
        ...
        raise ValueError("Response does not contain 'data': " + str(response.json()))
